...
\author[LSE Hackathon]{Ching Choo\footnote{\href{mailto:ching.choo@gtc.ox.ac.uk}{ching.choo@gtc.ox.ac.uk}}, Gabriel Burcea\footnote{\href{mailto:gb.burcea@gmail.com}{gb.burcea@gmail.com}}, Gavin Kader\footnote{\href{mailto:gav.kader@gmail.com}{gav.kader@gmail.com}}, Giacomo Mason\footnote{\href{mailto:mason.gcm@gmail.com}{mason.gcm@gmail.com}}, Sinem Polat\footnote{\href{mailto:sinemypolat@gmail.com}{sinemypolat@gmail.com}}}
...
\begin{itemize}
\item Data scrape stakeholder reports, pre-process, obtain stem words, "vectorise" stem words, "correlate"
\item Use Cosine Similarity as a measure of proximity \textit{(commonest measure of "correlation" for text analysis)}
\begin{itemize}
\item e.g. A = (python, python, pythoner, pythoning), B = (python, pythoned, pythoner)
\end{itemize}
\begin{table}[]
\centering
\begin{tabular}{lll}
...
\frametitle{\textbf{Who} are the GONGOs?}
%\begin{figure}[h!]
%\includegraphics[scale=0.7]{betterarctan2.pdf}
%\end{figure}
\end{frame}
\end{document}
